...
import com.karatesan.game.ui.HudRenderer;
import com.karatesan.game.ui.LevelUpController;
import com.karatesan.game.ui.LevelUpUIBuilder;
import com.karatesan.game.ui.PerkSelectionListener;
...
public class UISystem extends EntitySystem {
    ...
    private final ComponentMapper<UtilityStatsComponent> statsMapper = ComponentMapper.getFor(UtilityStatsComponent.class);
    private final ComponentMapper<PerkInventoryComponent> perkMapper = ComponentMapper.getFor(
        PerkInventoryComponent.class);
    private final ComponentMapper<LevelDataComponent> lvlM = ComponentMapper.getFor(LevelDataComponent.class);
    ...
    public void update(float deltaTime) {
        ...
        LevelDataComponent levelDataComponent = lvlM.get(player);
        hudRenderer.drawXpBar(levelDataComponent.currentXp, levelDataComponent.xpToNextLevel, screenW, screenH);

        batch.end();

        PerkInventoryComponent inventory = perkMapper.get(player);
        UtilityStatsComponent statsComponent = statsMapper.get(player);
